...
public class ModItems {
	...
	public static final Item FIREFLY_SPAWN_EGG = register("firefly_spawn_egg", new SpawnEggItem(ModEntities.FIREFLY, 0x343338, 0x00FFFA, new FabricItemSettings().group(TAB)));
